...
# GEMINI
* **gemini hello** : hello to gemini
* **gemini bye** : bye bye
* **mini gemini** : geeeeminiii
* **monogo** : menogooo
...
# DOCKER COMPOSE
* **docker-compose up** : Creates and starts all services defined in a YAML file
* **docker-compose down** : Stops services and removes created containers and networks
* **docker-compose build** : Builds images for the services in the YAML file
...
* **docker network inspect** : Shows detailed information about a network
* **docker network connect** : Connects an existing container to a network
* **docker network disconnect** : Disconnects a container from a network
* **docker network rm** : Deletes an unused network
...
* **docker volume inspect** : Provides detailed information about one or more volumes
* **docker volume rm** : Deletes selected volumes
